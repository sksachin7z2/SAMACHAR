...
export class News extends Component {
      ...
      async componentDidMount(){
          ...
          let url="https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b52ac02e639d49c9836f1f40154b16b2&page=1&pageSize=20";
      ...
      handleprevclick=async()=>{
        let url=`https://newsapi.org/v2/top-headlines?country=us&category=business&apiKey=b52ac02e639d49c9836f1f40154b16b2&page=${this.state.page-1}&pageSize=20`;
        let data= await fetch(url);
        let parsedData= await data.json();
          console.log(parsedData);
